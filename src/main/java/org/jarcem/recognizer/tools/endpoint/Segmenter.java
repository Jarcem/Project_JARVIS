package org.jarcem.recognizer.tools.endpoint;

import org.jarcem.recognizer.frontend.Data;
import org.jarcem.recognizer.frontend.FrontEnd;
import org.jarcem.recognizer.frontend.util.AudioFileDataSource;
import org.jarcem.recognizer.frontend.util.WavWriter;
...
public class Segmenter {
    ...
    public static void main(String[] argv) throws MalformedURLException,
        ...
        if ((inputFile == null && inputCtl == null) || outputFile == null) {
            System.out
                    .println("Usage: java  -cp lib/batch.jar:lib/sphinx4.jar Segmenter "
