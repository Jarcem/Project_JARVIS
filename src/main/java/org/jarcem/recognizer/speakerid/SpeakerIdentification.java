 ...
 *
 */
package org.jarcem.recognizer.speakerid;
...
public class SpeakerIdentification {
    ...
    /**
     * @param mat A matrix with feature vectors as rows.
    ...
    /**
     * @param bicValue The bicValue of the model represented by only one Gaussian.
     ...
     * @param length   The length of the interval, as numbers of frames
     * @param features The matrix build with feature vectors as rows
    ...
    /**
     * @param features Matrix with feature vectors as rows
    ...
    /**
     * @param Clustering The array of clusters
     * @param posi       The index of the merged cluster
     * @param posj       The index of the cluster that will be eliminated from the
     *                   clustering
    ...
    /**
     * @param lst An ArrayList with all the values being vectors of the same
     *            dimension
