...
public class Tester {
     ...
     *
     * @param vectorSize    The dimension of a feature vector
     * @param vectorsCount  The number of features vectors per speakers
     * @param speakersCount The number of speakers
     ...
     *
     * @param vectorSize    number of features (Segment.FEATURES_SIZE)
     * @param vectorsCount  number of frames for each speaker
     * @param speakersCount number of speakers
     */
     ...
     * @param vectorsCount  number of frames for each speaker
     * @param speakersCount number of speakers
     * @param repeatFactor  number of times the input should be repeated
     */
     ...
     *
     * @param inputFile the input file that needs to be diarized
