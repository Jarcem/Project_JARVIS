 ...
 *
 */
package org.jarcem.recognizer.linguist.flat;
...
import org.jarcem.recognizer.linguist.language.grammar.Grammar;
import org.jarcem.recognizer.linguist.language.grammar.GrammarArc;
import org.jarcem.recognizer.linguist.language.grammar.GrammarNode;
import org.jarcem.recognizer.util.Cache;
import org.jarcem.recognizer.util.LogMath;
import org.jarcem.recognizer.util.StatisticsVariable;
...
public class FlatLinguist implements Linguist, Configurable {
    ...
    protected class FlatSearchGraph implements SearchGraph {
         ...
         * (non-Javadoc)
         *
         * @see SearchGraph#getInitialState()
         */
         ...
         * (non-Javadoc)
         *
         * @see SearchGraph#getNumStateOrder()
         */
