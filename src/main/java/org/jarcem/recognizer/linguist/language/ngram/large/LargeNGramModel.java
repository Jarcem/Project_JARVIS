...
public class LargeNGramModel implements LanguageModel {
    ...
    public LargeNGramModel(String format, URL location, String ngramLogFile,
                           ...
                           int maxDepth, org.jarcem.recognizer.linguist.dictionary.Dictionary dictionary,
     ...
     * (non-Javadoc)
     *
     * @see Configurable#newProperties(org.jarcem.recognizer.
     ...
     * @param firstNMinus1GramEntry the index of the first N-1Gram entry of the N-1Gram in
     *                              question
