...
import org.jarcem.recognizer.util.props.S4StringList;
...
public class InterpolatedLanguageModel implements LanguageModel {
     ...
     *
     * @see LanguageModel#getProbability(WordSequence)
     */
     ...
     * (non-Javadoc)
     * @see
     * LanguageModel#getSmear(edu.cmu
