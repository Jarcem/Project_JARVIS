...
public class SimpleNGramModel implements LanguageModel {
    ...
    private org.jarcem.recognizer.linguist.dictionary.Dictionary dictionary;
    ...
    public SimpleNGramModel(String location, org.jarcem.recognizer.linguist.dictionary.Dictionary dictionary,
    ...
    public SimpleNGramModel(URL urlLocation, org.jarcem.recognizer.linguist.dictionary.Dictionary dictionary,
                            float unigramWeight, int desiredMaxDepth) {
     ...
     * (non-Javadoc)
     * @see
     * Configurable#newProperties(org.jarcem.recognizer.
    ...
    public void newProperties(PropertySheet ps) throws PropertyException {
        ...
        dictionary = (org.jarcem.recognizer.linguist.dictionary.Dictionary) ps.getComponent(PROP_DICTIONARY);
