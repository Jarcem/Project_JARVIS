 ...
 *
 */
package org.jarcem.recognizer.linguist.language.grammar;
...
public class FSTGrammar extends Grammar {
    ...
    public FSTGrammar(String path, boolean showGrammar, boolean optimizeGrammar, boolean addSilenceWords, boolean addFillerWords, org.jarcem.recognizer.linguist.dictionary.Dictionary dictionary) {
    ...
    protected GrammarNode createGrammar() throws IOException {
        ...
        finalNode = createGrammarNode(++maxNodeId, org.jarcem.recognizer.linguist.dictionary.Dictionary.SILENCE_SPELLING);
        ...
        while (!tok.isEOF()) {
            ...
            if (token == null) {
                ...
                initialNode = createGrammarNode(initialID,
                        org.jarcem.recognizer.linguist.dictionary.Dictionary.SILENCE_SPELLING);
