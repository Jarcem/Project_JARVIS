...
public abstract class Grammar implements Configurable, GrammarInterface {
     ...
     */
    @S4Component(type = org.jarcem.recognizer.linguist.dictionary.Dictionary.class)
    ...
    protected org.jarcem.recognizer.linguist.dictionary.Dictionary dictionary;
    ...
    public Grammar(boolean showGrammar, boolean optimizeGrammar, boolean addSilenceWords, boolean addFillerWords, org.jarcem.recognizer.linguist.dictionary.Dictionary dictionary) {
