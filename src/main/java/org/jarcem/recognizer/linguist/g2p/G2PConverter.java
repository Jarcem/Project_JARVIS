...
package org.jarcem.recognizer.linguist.g2p;
...
public class G2PConverter {
     ...
     *
     * @param g2pModelUrl the URL of the serialized model
     ...
     * Phoneticize a word
     *
     * @param entry the word to phoneticize transformed to an ArrayList of Strings
     ...
     * Phoneticize a word
     *
     * @param word  the word to phoneticize
     * @param nbest the number of distinct pronunciations to return
     * @return the pronunciation(s) of the input word
     */
