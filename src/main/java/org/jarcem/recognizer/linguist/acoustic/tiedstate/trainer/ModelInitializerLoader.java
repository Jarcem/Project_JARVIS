...
package org.jarcem.recognizer.linguist.acoustic.tiedstate.trainer;
...
import org.jarcem.recognizer.linguist.acoustic.tiedstate.*;
import org.jarcem.recognizer.util.ExtendedStreamTokenizer;
import org.jarcem.recognizer.util.LogMath;
import org.jarcem.recognizer.util.StreamFactory;
...
public class ModelInitializerLoader implements Loader {
    ...
    @S4String(defaultValue = "src/main/resources/data")
