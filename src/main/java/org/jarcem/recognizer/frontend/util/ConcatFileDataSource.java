...
import org.jarcem.recognizer.util.BatchFile;
 ...
 * DataStartSignal DataStartSignal} will be placed before the start of the first file, and a
 * {@link DataEndSignal DataEndSignal} after the last file. No DataStartSignal or DataEndSignal
 * will be placed between them. Optionally, silence can be added in-between the audio files by setting the property:
 * <pre>ConcatFileDataSource.silenceFile</pre>
