...
import org.jarcem.recognizer.frontend.denoise.Denoise;
import org.jarcem.recognizer.frontend.frequencywarp.MelFrequencyFilterBank;
...
import org.jarcem.recognizer.frontend.transform.DiscreteCosineTransform2;
import org.jarcem.recognizer.frontend.transform.KaldiDiscreteCosineTransform;
import org.jarcem.recognizer.frontend.transform.Lifter;
import org.jarcem.recognizer.linguist.acoustic.tiedstate.KaldiLoader;
...
public class AutoCepstrum extends BaseDataProcessor {
     ...
     * (non-Javadoc)
     * @see
     * DataProcessor#initialize(org.jarcem.recognizer.frontend
     * .CommonConfig)
     */
    @Override
