...
public class JSGFRuleGrammar {
     ...
     * @param manager the manager for the created Grammars
     */
     ...
     *
     * @param comment The String to expand into a multi or single line comment.
     ...
     * it does not exist.
     *
     * @param url The URL to save this JSGFRuleGrammar to.
     * @throws URISyntaxException If there was a problem converting the given url to uri.
     * @throws IOException        if an error occurs while saving or compiling the grammar
     */
