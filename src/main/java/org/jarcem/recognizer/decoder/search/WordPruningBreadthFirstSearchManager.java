...
public class WordPruningBreadthFirstSearchManager extends TokenSearchManager {
    ...
    // Instrumentation
    // -----------------------------------
    protected org.jarcem.recognizer.util.Timer scoreTimer;
    protected org.jarcem.recognizer.util.Timer pruneTimer;
    protected org.jarcem.recognizer.util.Timer growTimer;
