package org.jarcem.recognizer.decoder.adaptation;
...
import org.jarcem.recognizer.linguist.HMMSearchState;
...
public class Stats {
     ...
     *
     * @param componentScores from which the posterior values are computed.
     * @param numStreams      Number of feature streams
     ...
     *
     * @param result Result object to collect counts from.
