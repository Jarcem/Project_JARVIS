 ...
 *
 */
package org.jarcem.recognizer.result;

import org.jarcem.recognizer.decoder.search.AlternateHypothesisManager;
import org.jarcem.recognizer.decoder.search.Token;
import org.jarcem.recognizer.decoder.search.WordPruningBreadthFirstSearchManager;
...
import org.jarcem.recognizer.linguist.lextree.LexTreeLinguist;
 ...
 * {@link Result Results} which can be partial or final.
 * </p>
 * <p>
 ...
 * {@link Node Nodes} and
 * {@link Edge Edges}. A Node that corresponds to a theory
 ...
 * {@link WordPruningBreadthFirstSearchManager}
 ...
 * {@link WordSearchState} returns false on the
 ...
 * {@link LexTreeLinguist} and the
 * {@link WordPruningBreadthFirstSearchManager}.
 * </i>
 * </p>
 * <p>
 * Lattices can also be created from a collapsed
 * {@link Token} tree and its
 ...
 * {@link WordPruningBreadthFirstSearchManager}. A
...
public class Lattice {
     ...
     * @param token          the predecessor token of the token represented by the
     *                       parentWordNode
     ...
     * objects.
     *
     * @param languageModelWeightAdjustment the weight multiplier that will be applied to language score
     ...
     * @param languageModelWeightAdjustment the weight multiplier that will be applied to language score
     *                                      already scaled by language weight
     * @param useAcousticScoresOnly         use only the acoustic scores to compute the posteriors, ignore
